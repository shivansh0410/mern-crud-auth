...
mongoose.connect("mongodb+srv://vibhushivanshmishra:<password>@cluster0.9cyfdvj.mongodb.net/?retryWrites=true&w=majority");
var fs = require('fs');
...
var upload = multer({
  storage: multer.diskStorage({
    ...
    { 
      callback(null, file.fieldname + '-' + Date.now() + path.extname(file.pexels-photo-1006293.jpg)); 
    }
  ...
  fileFilter: function (req, file, callback) 
  {
    ...
    {
      return callback(res.end('Only images are allowed'), false)
    }
    callback(null, true)
  }
});
